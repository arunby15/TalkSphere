 ...
 <div className='space-y-6'>
  ...
  <div className='grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-2'>
   ...
   <h3 className='text-lg font-semibold mb-3'>Preview</h3>
    <div className=' border border-base-300 rounded-xl shadow-lg overflow-hidden bg-base-100'>
      <div className='p-4 bg-base-200'>
        <div className='max-w-lg mx-auto'>
          <div className='bg-base-100 rounded-xl shadow-sm overflow-hidden'>
            ...
            <div className='p-3 spcae-y-4 min-h[200px] overflow-y-auto bg-base-100'>
                ...
                key={message.id}
                 className={`flex ${message.isSent?"justify-end":" justify-start"}`}>
                  ...
                  >
                    ...
                    <p 
                    className={`
                    text-[10px] mt-1.5 ${message.isSent? "text-primary-content/70" : "text-base-content/70"}
                    `}
                    >
                      12:00 PM
